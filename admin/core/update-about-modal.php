...
$sql = 'UPDATE about_modal SET titre_modal="'.$titre.'", texte_modal="'.$texte.'", icone_modal="'.$_POST['icone_modal'].'" WHERE id='.$_POST["form-id"];
...
header('Location: ../index-about-modal.php');